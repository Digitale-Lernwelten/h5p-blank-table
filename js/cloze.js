(function ($, BlankTable) {
   ...
   */
  BlankTable.Cloze = function (solution, behaviour, defaultUserAnswer, l10n) {
    var self = this;
    var $input, $wrapper;
    ...
    this.checkAnswer = function () {
      ...
      var isCorrect = (!isQuestion) || correct(checkedAnswer);
      if (isCorrect) {
    ...
    this.showSolution = function () {
      if ((!isQuestion) || correct(this.getUserAnswer())) {
    ...
    this.correct = function () {
      return (!isQuestion) || correct(this.getUserAnswer());
    };
    ...
    this.toString = function () {
      ...
      var result = '<span class="h5p-input-wrapper" is-question="' + (isQuestion ? "1" : "0") + '"><input type="text" class="h5p-text-input" autocomplete="off" autocapitalize="off" spellcheck="false"' + extra + '></span>';
